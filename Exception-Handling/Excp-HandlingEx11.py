...
#Excp-HandlingEx11.py ----- generic except Block with alias name
try:
...
except Exception as rv: #generic except Block with alias name
    print("Oops Something went Wrong!",rv)
else:
    print("-------------else block---------------")
